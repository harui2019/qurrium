...
from typing import Literal, Union, Optional, NamedTuple, Hashable, Iterable, Any
...
class ExperimentPrototype():
    ...
    @classmethod
    @abstractproperty
    def _analysis_container(cls) -> AnalysisPrototype:
    ...
    def __init__(
        ...
        **kwargs
        ...
        for i in ['analysisInput', 'analysisContent']:
            if not hasattr(self._analysis_container, i):
    ...
    def _read_core(
        ...
        for k, v in export_material_set['adventures'].items():
            instance[k] = v
        instance['sideProduct'] = export_material_set['tales']
        # afterwards
        ...
        for k, v in mains.items():
            instance.reports[k] = cls._analysis_container.read(v, sides[k])
    ...
    def read(
        ...
        # TODO: use .zip to packing the experiment optionally
        # exportLocationSet = {
...
class QurryExperiment(ExperimentPrototype):
    ...
    @classmethod
    @property
    def _analysis_container(cls) -> QurryAnalysis:
    ...
    def analyze(
        ...
        **otherArgs
        ...
        analysis = self._analysis_container(
            ultimate_question=ultimate_question,
            serial=serial,
            **qs,
        )
